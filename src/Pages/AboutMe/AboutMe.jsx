      ...
      <section id='about' className='lg:pt-32 px-6 sm:px-10 lg:px-20 xl:px-32'>
        ...
        <div className='mt-10   w-full  rounded-lg p-6 container'>
          <p className='text-[#c4c0c0]  font-medium text-justify text-base sm:text-lg lg:text-xl leading-relaxed '>
            ...
            Despite not pursuing formal studies in computer science, my
            curiosity and determination led me to embark on a self-taught
            journey into web development in December 2023. Using resources like
            Google, YouTube, and the "Complete Web Development Course with
            Jhankar Mahbub" by Programming Hero, I have built a strong
            ...
            manage server-side functionalities and databases. I am actively
            honing my backend skills to achieve full-stack proficiency.
            <br />
            <br />
            My career aspiration is to contribute to the tech industry by
            applying my skills to innovative, real-world projects that deliver
            impactful solutions. I thrive in environments that value creativity,
            collaboration, and a commitment to excellence, and I am eager to
